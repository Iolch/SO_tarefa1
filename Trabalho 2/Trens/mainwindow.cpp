...
sem_t cross[2];     // Um semáforo para cada região crítica que passa mais de dois trens.
...
MainWindow::MainWindow(QWidget *parent) : QMainWindow(parent), ui(new Ui::MainWindow) {
    ...
    // Inicializa semáforos e arrays de estados.
    for(int i=0; i < N; i++){
        sem_init(&s[i], 0, 1);
    ...
    trem1 = new Trem(1, 60, 90, ui->slider1->maximum()-ui->slider1->value(), ui->slider1->maximum(), s, cross, estado_rc, trem_rc);
    trem2 = new Trem(2, 470, 30, ui->slider2->maximum()-ui->slider2->value(), ui->slider2->maximum(), s, cross, estado_rc, trem_rc);
    trem3 = new Trem(3, 870, 90, ui->slider3->maximum()-ui->slider3->value(), ui->slider3->maximum(), s, cross, estado_rc, trem_rc);
    trem4 = new Trem(4, 330, 270, ui->slider4->maximum()-ui->slider4->value(), ui->slider4->maximum(), s, cross, estado_rc, trem_rc);
    trem5 = new Trem(5, 600, 270, ui->slider5->maximum()-ui->slider5->value(), ui->slider5->maximum(), s, cross, estado_rc, trem_rc);
